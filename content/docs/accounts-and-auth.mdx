...
If the product should stop exposing workspace creation or invitations, change `NEXT_PUBLIC_ACCOUNT_MODE` and confirm the flags in `config/account.config.ts`.
