      ...
      items: [
        {
          ...
          items: [
            ...
            { title: 'Organizations', url: '/dashboard/organizations', icon: Package },
            { title: 'Billing', url: '/dashboard/billing', icon: Settings },
            { title: 'Subscriptions', url: '/dashboard/subscriptions', icon: Settings },
      ...
      items: [
        {
          ...
          icon: Settings,
          items: [
            { title: 'Profile', url: routes.app.settingsProfile, icon: UserCog },
            { title: 'Authentication', url: routes.app.settingsAuthentication, icon: Wrench },
            { title: 'Security', url: routes.app.settingsSecurity, icon: ShieldCheck },
            { title: 'Display', url: routes.app.settingsDisplay, icon: Monitor }
          ]
        },
