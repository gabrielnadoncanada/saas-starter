...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description:
      "How Tenviq collects, uses, shares, and protects personal information in connection with the Tenviq starter.",
  };
}
    ...
    body: (
      <>
        <p>
          ...
          and the Tenviq starter (collectively, the
          &ldquo;Product&rdquo;).
        </p>
        <p>
  ...
  return (
    <LegalPage
      ...
      meta={{
        ...
        description:
          "How we collect, use, share, and protect personal information in connection with the Tenviq marketing site and the Tenviq SaaS Starter.",
        lastUpdated: LAST_UPDATED,
        effective: EFFECTIVE,
        version: VERSION,
        footerLabel: "End · Privacy Policy",
      }}
    />
  );
}
