...
import { inviteOrganizationMemberAction } from '@/features/teams/actions/invite-organization-member.action';
...
type InviteOrganizationMemberPanelProps = {
  canInviteMembers: boolean;
};

export function InviteOrganizationMemberPanel({
  canInviteMembers
}: InviteOrganizationMemberPanelProps) {
      ...
      <CardContent>
        <form action={inviteAction} className="space-y-4">
          ...
          <Button
            ...
            disabled={isInvitePending || !canInviteMembers}
          >
            {isInvitePending ? (
              <>
