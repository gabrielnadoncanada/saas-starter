...
import { updateOrganizationAiSettingsAction } from "@/features/ai/actions/organization-ai-settings.actions";
...
export function OrganizationAiSettingsPanel({
  ...
  const [allowedModelIds, setAllowedModelIds] = useState(settings.allowedModelIds);
